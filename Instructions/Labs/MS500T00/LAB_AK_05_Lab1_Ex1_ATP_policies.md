...
2. 你仍应位于 Microsoft 365 Defender（以前的安全中心）。 如果没有，请在浏览器中输入 `https://security.microsoft.com`

3. 在“Microsoft 365 安全中心”的左侧导航窗格中，选择“策略和规则”，然后选择“威胁策略”  。

4. 在“威胁策略”窗口中，选择“租户允许/阻止列表” 。

5. 在“租户允许/阻止列表”窗口中，选择“URL” 。

6. 在“阻止 URL”窗口的“添加带有通配符的 URL”部分下，可以输入想要阻止的任何 URL 。 对于此测试实验室，在“输入有效 URL”字段中，输入 `http://tailspintoys.com` 以将其添加到策略中。

7. 选择 **添加** 。

1. 在痕迹导航路径中，选择“威胁策略”，然后选择“安全链接” 。
...
11. 在“URL 和单击保护设置”窗格上，选择以下选项，然后单击“下一步” ：

    - 在“针对电子邮件中的潜在恶意 URL 的操作”下选择“开: 当用户单击电子邮件中的链接时，安全链接将根据已知恶意链接列表进行检查。URL 默认重写。”

    - 选中“对可疑链接和指向文件的链接应用实时 URL 扫描”旁边的复选框。

    - 选中“将安全链接应用于组织内发送的电子邮件”旁边的复选框。

12. 在“针对 Microsoft Teams 中的潜在恶意 URL 的操作”下选择“开: 当用户单击 Microsoft Teams 中的链接时，安全链接将根据已知恶意链接列表进行检查。URL 不会重写。”

13. 在“通知”窗格中，保留选中的默认通知文本。 单击“下一步”。

14. 在“查看”窗格中，选择“提交”以创建策略 。

15. 将“Office 365 安全与合规”选项卡保持打开状态，以便在稍后的任务中使用。
...
2. 在 Edge 浏览器中，选择“Microsoft 365 安全中心”标签页。 

3. 在“Microsoft 365 安全中心”的左侧导航窗格中，选择“策略和规则”，然后选择“威胁策略”  。

4. 在“威胁策略”窗口中，选择“安全附件”。 
...
8. 在“用户和域”中，在“组”字段中输入 `All Company`，然后选择“下一步”。  
